...
public class SharedPrefsHelper {
    ...
    private static final String SHARED_PREFS_NAME = "HamsaApp";
    ...
    private SharedPrefsHelper() {
        instance = this;
        sharedPreferences = MessengerApplication.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    }
